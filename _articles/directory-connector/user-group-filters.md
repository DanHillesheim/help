...
You may also enable this option directly in the Directory Connector [configuration file](/directory-sync-shared/#config-file) (`data.json`) by setting `"largeImport": true`:
