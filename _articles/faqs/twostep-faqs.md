...
**A:** You can require your Organization's users to use Two-step Login by enabling the [Two-step Login Policy](/policies/#two-step-login). Additionally, you can setup [Organization-wide Duo 2FA](/two-step-login-duo) to ensure that all of your users have a secure Two-step Login method at their disposal.
