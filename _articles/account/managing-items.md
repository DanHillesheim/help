...
Login items are most often used to store username and password combinations, and support [TOTP seeds](/authenticator-keys/) for Premium users. Whatever plan you're on, we recommend giving every Login a [URI for easy auto-fill](/uri-match-detection):
...
If you're a member of an [Organization](/about-organizations/), you can move Vault items to your Organization for sharing with other Organization members. Learn more about [Organizations](/about-organizations/), [Collections](/about-collections), and [Sharing](/sharing/).
